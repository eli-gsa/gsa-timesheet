...
import { contrastText, fmtHours, slotRangeLabel } from "@/lib/types";
import { assignSlots, clearSlots } from "@/lib/actions/timesheet";
          ...
          <thead>
            <tr>
              ...
              {slots.map((s) => (
                <th
                  key={s}
                  className="sticky top-0 z-10 bg-[#f3f2ee] text-[9.5px] font-normal text-[#898781] text-center px-0 py-1 border-b-2 border-r border-[#e1e0d9] w-[70px]"
                >
                  {slotRangeLabel(s)}
                </th>
              ))}
                  ...
                  {slots.map((s) => {
                    ...
                    return (
                      <td
                        ...
                        className={`h-[22px] w-[70px] border border-[#e1e0d9] p-0 box-border ${
